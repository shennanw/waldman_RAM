...
structure=data.frame(t(subjcode), t(blocks), t(sequences), t(Y_array), t(soz[12,]))  ### loc+1 in soz
...
gran2loc11=rbind(gran2loc.event3, gran2loc.event2, gran2loc.event1, gran2loc.event0)
write.table(gran2loc12, file="gran2loc11.csv", row.names = F, sep="|")
gran2loc11[1:5,]
