...
structure=data.frame(t(subjcode), t(blocks), t(sequences), t(Y_array), t(soz[8,]))  ### loc+1 in soz
...
gran2loc7=rbind(gran2loc.event3, gran2loc.event2, gran2loc.event1, gran2loc.event0)
