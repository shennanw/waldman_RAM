...
Lj=loc+5
Lk=loc+1
gran2loc=cbind(granularity2[, c(1:4,Lj)], X_array_2a[,Lk], X_array_2b[,Lk], X_array_2c[,Lk])
...
gran2loc12=rbind(gran2loc.event3, gran2loc.event2, gran2loc.event1, gran2loc.event0)
